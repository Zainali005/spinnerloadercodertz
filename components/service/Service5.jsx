...
function Service5() {
  return (
    <>
      <div className="service-section5 pb-120">
        <img
          ...
          <div className="row justify-content-center g-4">
            <div className="col-lg-4 col-md-6 col-sm-10">
              ...
              >
                ...
                <div className="service-title">
                  <h4>
                    <Link href="/service-details">Crative Ui/Ux Design</Link>
                  </h4>
                </div>
                <p className="para mb-0">
                  Get the most of reduction in your team’s operating costs for
                  the whole. reduction in your team’s
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-10">
            ...
            <div className="col-lg-4 col-md-6 col-sm-10">
              ...
              >
                ...
                <div className="service-title">
                  <h4>
                    <Link href="/service-details">Plugin Development</Link>
                  </h4>
                </div>
                <p className="para mb-0">
                  Get the most of reduction in your team’s operating costs for
            ...
            <div className="col-lg-4 col-md-6 col-sm-10">
              ...
              >
                ...
                <div className="service-title">
                  <h4>
                    <Link href="/service-details">Web Security Services</Link>
                  </h4>
                </div>
                <p className="para mb-0">
                  Get the most of reduction in your team’s operating costs for
            ...
            <div className="col-lg-4 col-md-6 col-sm-10">
              ...
              >
                ...
                <div className="service-title">
                  <h4>
                    <Link href="/service-details">Professional Writer</Link>
                  </h4>
                </div>
                <p className="para mb-0">
                  Get the most of reduction in your team’s operating costs for
