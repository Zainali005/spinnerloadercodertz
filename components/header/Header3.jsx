            ...
            <div className="address-card mb-5">
              <div className="content">
                ...
                <ul className="address-list">
                  ...
                  <li>
                    <span>Email:</span> info@codeertz.com
                  </li>
                </ul>
              </div>
      ...
      <header className="header-area style-1 style-3">
        ...
        >
          <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
            ...
            <div onClick={handleMobileMenu} className="menu-close-btn">
              <i
                className={
                  showMobileMenu === 1
                    ? "bi bi-x-lg text-white bi-chevron-down closeBtnMobile"
          ...
          <ul className="menu-list">
            ...
            >
              <Link href="/project" className="drop-down">
                <a>Projects</a>
              </Link>
            </li>
            <li>
          ...
          <div className="d-lg-none d-block">
            <form className="mobile-menu-form"></form>
          </div>
        </div>
        <div className="nav-right style-2 d-flex align-items-center gap-5">
          ...
          <div className="hotline d-xxl-flex d-none">
            ...
            <div className="hotline-info">
              <span>Messge Us</span>
              <h6>
                <a href="mailto:info@example.com">info@codeertz.com</a>
              </h6>
            </div>
          </div>
