   ...
   <div className={sidebar ===1 ? "menu-toggle-btn-full-shape show-sidebar":"menu-toggle-btn-full-shape"}>
    ...
    <div className={showSearch === 1? "mobile-search slide":"mobile-search"}>
      ...
      <header className="header-area style-1 style-3">
          ...
          <ul className="menu-list">
            <li className="menu-item-has-children"onClick={() => dispatch({type: 'homeOne'})}>
              ...
              <ul className={state.activeMenu ==='homeOne'? "sub-menu d-block": "sub-menu d-none"}>
                ...
                <li>
                  <Link href="/index2"><a>Home 2</a></Link>
                </li>
                <li>
                  <Link href="#"><a>Home 3</a></Link>
                </li>
                <li>
                  <Link href="/index4"><a>Home 4</a></Link>
                </li>
                <li>
                  <Link href="/index5"><a>Home 5</a></Link>
                </li>
              </ul>
            </li>
              ...
              <ul  className={state.activeMenu ==='pages'? "sub-menu d-block": "sub-menu d-none"}>
                ...
                <li onClick={handleMobileSubMenu}>
                  ...
                  showMobileSubMenu ===1
                    ...
                    <li>
                    <Link href="#"><a>Child 1</a></Link>
                    </li>
                    <li>
                    <Link href="#"><a>Child 2</a></Link>
                    </li>
                    <li>
                    <Link href="#"><a>Child 3</a></Link>
                    </li>
                    <li>
                      <Link href="#"><a>Child 4</a></Link>
                    </li>
                  </ul>
                </li>
              </ul>
            ...
            <li className="menu-item-has-children" onClick={() => dispatch({type: 'service'})}>
              ...
              <ul className={state.activeMenu ==='service'? "sub-menu d-block": "sub-menu d-none"}>
                ...
                <li>
                  <Link href="/service-details"><a>Services Details</a></Link>
                </li>
              </ul>
            </li>
            <li className="menu-item-has-children" onClick={() => dispatch({type: 'project'})}>
              ...
              <ul className={state.activeMenu ==='project'? "sub-menu d-block": "sub-menu d-none"}>
                ...
                <li>
                  <Link href="/project-details"><a>Projects Details</a></Link>
                </li>
              </ul>
            </li>
            <li className="menu-item-has-children" onClick={() => dispatch({type: 'blog'})}>
              ...
              <ul className={state.activeMenu ==='blog'? "sub-menu d-block": "sub-menu d-none"}>
                ...
                <li>
                  <Link href="/blog-standard"><a>Blog Standard</a></Link>
                </li>
                <li>
          ...
          <div className="d-lg-none d-block">
            <form className="mobile-menu-form">
              <div className="input-with-btn d-flex flex-column">
                ...
                <button type="submit" className="eg-btn btn--primary3 btn--sm">
                  Search
                </button>
              </div>
            </form>
        ...
        <div className="nav-right style-2 d-flex align-items-center gap-5">
          ...
          <div className="eg-btn btn--primary3 header-btn">
            <Link href="/contact"><a>LET S TALK</a></Link>
          </div>
        </div>
      </header>
    </>
