...
function ServiceDetailsProduct() {
  ...
  return (
    <>
      <Layout>
        <Breadcrumb
          pageName="Services Details Product"
            ...
            <div className="row justify-content-center g-4">
              ...
              <div className="col-lg-8">
                <div className="service-details-area">
                  <img
                    src="assets/images/bg/prod-services.jpg"
                    className="img-fluid"
                    alt="image"
                  />
                  <h3>
                    Explore Our Comprehensive Product Development Services
                  </h3>
                  <p className="para">
                  ...
                  <p className="para">
                    ...
                    existing one, or streamline your product development
