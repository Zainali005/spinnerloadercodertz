            ...
            <div className="col-lg-4">
              ...
              <div className="col-lg-8">
                <div className="service-details-area">
                  <img
                    src="assets/images/bg/ios-app.jpg"
                    className="img-fluid"
                    alt="image"
                  />
                  ...
                  <p className="para">
                    ...
                    designed to meet the evolving needs of businesses in todays
                  ...
                  <p className="para">
                    ...
                    an existing one, or streamline your app development
                  ...
                  <p className="para mb-40">
                    Lets imagine an app startup—well call it Beautify. Beautify
