...
function ServiceDetailsProduct() {
  const [activeTab, setActiveTab] = useState("Shopify/WooCommerce");
  ...
  return (
    <>
      <Layout>
        <Breadcrumb
          pageName="Services Details Shopify"
            ...
            <div className="row justify-content-center g-4">
              ...
              <div className="col-lg-8">
                <div className="service-details-area">
                  <img
                    src="assets/images/bg/Shopify-Development-Services.png"
                    className="img-fluid"
                    alt="image"
                  />
                  ...
                  <p className="para">
                    Whether you are looking to build a new Shopify store,
