...
function serviceDetailsProduct() {
  ...
  return (
    <>
      <Layout>
        <Breadcrumb
          pageName="Services Details Models"
            ...
            <div className="col-lg-4">
              ...
              <div className="col-lg-8">
                <div className="service-details-area">
                  <img
                    src="assets/images/bg/machine-learning.png"
                    className="img-fluid"
                    alt="image"
                  />
                  <h3>
                    Explore Our Comprehensive ML Model Development Services
                  </h3>
                  <p className="para">
                  ...
                  <p className="para">
                    Whether you are looking to develop a new ML model, enhance
                    an existing one, or streamline your ML processes, our
                    experts are here to deliver top-notch service tailored to
                    your goals.
                  </p>
