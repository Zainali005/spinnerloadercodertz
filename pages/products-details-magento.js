              ...
              <div className="col-lg-8">
                <div className="service-details-area">
                  ...
                  <p className="para">
                    ...
                    digital environment. From theme customization and module
                    development to website optimization and maintenance, we
                  ...
                  <p className="para mb-40">
                    Lets imagine a Magento startup—well call it Beautify.
                    Beautify develops all-natural cosmetics and uses Magento to
                    create an engaging online store that focuses on user
                    experience. Some of the key team members behind this small
                    but successful startup include a product manager, a Magento
