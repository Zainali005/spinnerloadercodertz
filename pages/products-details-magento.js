            ...
            <div className="row justify-content-center g-4">
              ...
              <div className="col-lg-8">
                <div className="service-details-area">
                  ...
                  <p className="para">
                    Our team offers a wide range of Magento services designed to meet the evolving needs of businesses in today's fast-paced digital environment. From theme customization and module development to website optimization and maintenance, we provide solutions that enhance your online presence and drive engagement.
                  </p>
                  <p className="para">
                    Whether you are looking to build a new Magento site, redesign your existing one, or streamline your e-commerce processes, our experts are here to deliver top-notch service tailored to your goals.
                  </p>
                  ...
                  <h3 className="service-subtitle">From Idea to Magento Implementation</h3>
                  <p className="para mb-40">
                    Let's imagine a Magento startup—well call it Beautify. Beautify develops all-natural cosmetics and uses Magento to create an engaging online store that focuses on user experience. Some of the key team members behind this small but successful startup include a product manager, a Magento developer, a front-end developer, a data analyst, and a digital marketer.
                  </p>
                    ...
                    <div className="row g-4">
                      <div className="col-md-3 col-sm-6">
                        <div className="work-process-item">
                          <img src="assets/images/icons/work-procs1.svg" alt="image" />
                          <h4>Research</h4>
                        </div>
                      </div>
                      <div className="col-md-3 col-sm-6">
                        <div className="work-process-item">
                          <img src="assets/images/icons/work-procs2.svg" alt="image" />
                          <h4>Idea</h4>
                        </div>
                      </div>
                      <div className="col-md-3 col-sm-6">
                        <div className="work-process-item">
                          <img src="assets/images/icons/work-procs3.svg" alt="image" />
                          <h4>Develop</h4>
                        </div>
                      </div>
                      <div className="col-md-3 col-sm-6">
                        <div className="work-process-item">
                          <img src="assets/images/icons/work-procs4.svg" alt="image" />
                          <h4>Launch</h4>
                        </div>
                      </div>
                    </div>
